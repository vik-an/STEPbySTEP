...
app.set("views", path.join(__dirname, "views")); //nustato kad vaizdu ieskos views faile, ir daugiau jo kartoti nebereikia
app.use(express.static(path.join(__dirname, "public"))); //  IR VISTIEK  neveikia...
